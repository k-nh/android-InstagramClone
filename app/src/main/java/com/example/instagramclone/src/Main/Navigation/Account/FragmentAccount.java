package com.example.instagramclone.src.Main.Navigation.Account;
...
import com.example.instagramclone.src.Main.Navigation.Account.UserInfo.FragmentUserInfo;
...
import com.example.instagramclone.src.Main.Navigation.Account.interfaces.AccountActivityView;
import com.example.instagramclone.src.Main.Navigation.Account.interfaces.followActivityView;
...
public class FragmentAccount extends Fragment implements AccountActivityView, followActivityView {
    ...
    public void AccountSuccess(AccountResponse accountResponse) {
        ...
        for (com.example.instagramclone.src.Main.Navigation.Account.Models.AccountResponse.FeedList r : accountResponse.getAccountResult().getFeedList())
        ...
        switch (relation){
            case 'A':
                ...
                user_relation_A.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        ((MainActivity)getActivity()).replaceFragment(FragmentUserInfo.newInstance());
