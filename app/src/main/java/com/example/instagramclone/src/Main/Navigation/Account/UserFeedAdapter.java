...
public class UserFeedAdapter extends RecyclerView.Adapter<UserFeedAdapter.ImgViewHolder> {
    ...
    @NonNull
    @Override
    public UserFeedAdapter.ImgViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull UserFeedAdapter.ImgViewHolder holder, int position) {
    ...
    public void setOnItemClickListener(UserFeedAdapter.OnItemClickListener listener){
